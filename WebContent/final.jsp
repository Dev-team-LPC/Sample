                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card mb-4">
								...
								<table class="table table-bordered table-condensed table-responsive text-nowrap table-sm table-hover">
									...
									%>
									<tr class='clickable-row' data-href='<%=request.getContextPath()%>/DashboardController?action=edit-final-reports&report_id=<%=report_id%>&sla_id=<%=sla_id%>&months=<%=months%>' title="click to open report">
										<td><%=report_status%></td>
										<td><%=sla_name%></td>
